...
US_ModelLoader::US_ModelLoader( bool dbSrc, QString& search,
  ...
  :US_WidgetsDialog( 0, Qt::WindowFlags() ), loadDB( dbSrc ), dsearch( search ),
...
QDateTime time2=QDateTime::currentDateTime();
   ...
   QRegularExpression mpart = QRegularExpression( QRegularExpression::wildcardToRegularExpression(mflt1),
