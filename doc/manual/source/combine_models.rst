...
.. list-table::
  ...
  * - **Select PreFilter:**
    - Open a :doc:`Models Pre-Filter dialog <fe-data-loader>` to select Run IDs on which to pre-filter lists of models for loading. 
  * - **Add Models**
    - Open a :doc:`Model Loader dialog <fe-model-loader>` to select model(s) to load into the list of component models to the global model.
  * - **Reset List**
