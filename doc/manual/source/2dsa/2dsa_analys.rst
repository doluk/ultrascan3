...
*  **Step 1:** *Define the Grid and Grid points:* With *Fitting Controls*, define the overall solute grid by giving the lower and upper limits of s and f/f0; and the the number of grid points for s and f/f0. The default 64 grid points work well for typical Sedimentation velocity datasets. that total grid into subgrids using Grid Refinements.
*  **Step 2:** *Set Refinement Iterations:* Secondly, set a value for Maximum Iterations of refinement passes.
*  **Step 3:** *Set any Meniscus/Monte Carlo:* Thirdly, if desired, set parameters defining a Meniscus scan or set of Monte Carlo iterations.
